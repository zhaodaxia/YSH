...
public class FlouActivity extends Activity implements OnClickListener{
	...
	private void initData(String regid) {
		...
		MyApplication.httpUtils.send(HttpMethod.POST, HttpUrl.FENGLOU, params, new RequestCallBack<String>() {

			@Override
			public void onFailure(HttpException arg0, String arg1) {
				Toast.makeText(FlouActivity.this, "数据加载失败", Toast.LENGTH_SHORT).show();
			}
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				if (arg0 != null && !arg0.result.isEmpty()){
					fengLouInfo = MyApplication.gson.fromJson(json, FengLouInfo.class);
					//SnaAdater san = new SnaAdater(SnanActivity.this,stores_Info);
					if (!fengLouInfo.phoenix.isEmpty() && fengLouInfo.phoenix.size()!=0) {
						Log.i("json=", json);//CID为空
						GridviewAdapter gridviewAdapter = new GridviewAdapter(FlouActivity.this,fengLouInfo);
						gview.getRefreshableView().setAdapter(gridviewAdapter);
						
					}else {
						ToastUtils.show(FlouActivity.this, "该地区暂时无服务");
						GridviewAdapter gridviewAdapter = new GridviewAdapter(FlouActivity.this,fengLouInfo);
						gview.getRefreshableView().setAdapter(gridviewAdapter);
	...
	private void initListener() {
		// TODO Auto-generated method stub
		gview.getRefreshableView().setOnItemClickListener(new OnItemClickListener() {

			@Override
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stubs
				Intent intent = new Intent(FlouActivity.this,DetailsActivity.class);
				intent.putExtra("phoid",fengLouInfo.phoenix.get(arg2).phoid );
				intent.putExtra("pho_age",fengLouInfo.phoenix.get(arg2).pho_age );
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.fanhui:
			SharedPreferencesUtil.saveStringData(FlouActivity.this, "position", "-1");
			SharedPreferencesUtil.saveStringData(FlouActivity.this, "areaName","");
			finish();
			break;
		case R.id.quyu:
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if(requestCode == 0 && resultCode==1){
			...
			String areaName = SharedPreferencesUtil.getStringData(FlouActivity.this, "areaName", "");
